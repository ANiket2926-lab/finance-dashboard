  ...
  return (
    <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 overflow-hidden transition-all duration-300">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-900/30 text-gray-400 hover:text-rose-600 dark:hover:text-rose-400 transition-colors"
      ...
      <div className="md:hidden divide-y divide-gray-100 dark:divide-gray-800/50">
        {transactions.map((t) => (
          <div key={t.id} className="p-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-colors">
            ...
            {isAdmin && (
              <div className="flex items-center justify-end gap-2 mt-3">
                <button
                  onClick={() => onEdit?.(t)}
                  className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 transition-colors"
                >
                  <Pencil className="h-3 w-3" /> Edit
                </button>
                <button
                  onClick={() => handleDelete(t.id)}
                  className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-rose-50 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400 transition-colors"
                >
